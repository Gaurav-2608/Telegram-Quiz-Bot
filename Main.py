...
def start_command_handler(update, context):
    ...
    quiz_question1 = QuizQuestion()
    quiz_question1.question = "What is the capital of India?"
    quiz_question1.answers = ["New Delhi", "Mumbai", "Calcutta"]
    quiz_question1.correct_answer_position = 0
    quiz_question1.correct_answer = "New Delhi"

    add_quiz_question(update, context, quiz_question1)
...
def main():
    updater = Updater("5570008586:AAFPGSSiGlGwH190tVP9GK_CWP9szaNM6A8", use_context=True)
